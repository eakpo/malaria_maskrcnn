...
class CustomConfig(Config):
    ...
    NUM_CLASSES = 1 + 5  # Background + pf + pm + po + pv  + wbc
...
def train(model):
    ...
    dataset_train.load_custom("/content/Mask-R-CNN-using-Tensorflow2/dataset_raw/combined_annot_raw", "train", '/content/Mask-R-CNN-using-Tensorflow2/dataset_raw/combined_annot_raw/train/combined_train_vgg.json')
    dataset_train.prepare()

    # Validation dataset
    dataset_val = CustomDataset()
    dataset_val.load_custom("/content/Mask-R-CNN-using-Tensorflow2/dataset_raw/combined_annot_raw", "val",'/content/Mask-R-CNN-using-Tensorflow2/dataset_raw/combined_annot_raw/val/combined_val_vgg.json')
    dataset_val.prepare()
