...
def train(model):
    ...
    dataset_train.load_custom("/content/Mask-R-CNN-using-Tensorflow2/dataset_raw/pf", "train", '/content/ask-R-CNN-using-Tensorflow2/dataset_raw/pf/train/pf_train_json.json')
    dataset_train.prepare()

    # Validation dataset
    dataset_val = CustomDataset()
    dataset_val.load_custom("/content/Mask-R-CNN-using-Tensorflow2/dataset_raw/pf", "val",'/content/Mask-R-CNN-using-Tensorflow2/dataset_raw/pf/val/pf_val_json.json')
    dataset_val.prepare()
