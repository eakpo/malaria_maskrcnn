...
def train(model):
    ...
    dataset_train.load_custom("/content/Mask-R-CNN-using-Tensorflow2/dataset_raw/pm", "train", '/content/drive/Mask-R-CNN-using-Tensorflow2/dataset_raw/pm/train/pm_train_json.json')
    dataset_train.prepare()

    # Validation dataset
    dataset_val = CustomDataset()
    dataset_val.load_custom("/content//Mask-R-CNN-using-Tensorflow2/dataset_raw/pm", "val",'/content/drive/Mask-R-CNN-using-Tensorflow2/dataset_raw/pm/val/pm_val_json.json')
    dataset_val.prepare()
