...
def train(model):
    ...
    dataset_train.load_custom("/content/Mask-R-CNN-using-Tensorflow2/dataset_raw/po", "train", '/content/Mask-R-CNN-using-Tensorflow2/dataset_raw/po/train/po_train_json.json')
    dataset_train.prepare()

    # Validation dataset
    dataset_val = CustomDataset()
    dataset_val.load_custom("/content/Mask-R-CNN-using-Tensorflow2/dataset_raw/po", "val",'/content/Mask-R-CNN-using-Tensorflow2/dataset_raw/po/val/po_val_json.json')
    dataset_val.prepare()
