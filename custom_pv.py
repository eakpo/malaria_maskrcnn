...
import skimage.draw
import cv2
from mrcnn1.visualize import display_instances
import matplotlib.pyplot as plt
import imgaug

# Root directory of the project
ROOT_DIR = "/content/drive/MyDrive/Colab Notebooks/Mask-R-CNN-using-Tensorflow2"
# ROOT_DIR = "/kaggle/input/mrk-project2/Mask-R-CNN-using-Tensorflow2"
...
class CustomConfig(Config):
    ...
    NUM_CLASSES = 1 + 2  # Background + pf + pm + po + pv  + wbc
...
class CustomDataset(utils.Dataset):
    ...
    def load_custom(self, dataset_dir, subset, json_path):
        ...
        for a in annotations:
            ...
            # name_dict = {"pf": 1,"pm": 2,"po": 3,"pv": 4,"wbc": 5}
            name_dict = {"pv": 1,"wbc": 2}
...
def train(model):
    ...
    dataset_train.load_custom("/content/drive/MyDrive/Colab Notebooks/Mask-R-CNN-using-Tensorflow2/dataset_raw/pv", "train", '/content/drive/MyDrive/Colab Notebooks/Mask-R-CNN-using-Tensorflow2/dataset_raw/pv/train/pv_train_json.json')
    dataset_train.prepare()

    # Validation dataset
    dataset_val = CustomDataset()
    dataset_val.load_custom("/content/drive/MyDrive/Colab Notebooks/Mask-R-CNN-using-Tensorflow2/dataset_raw/pv", "val",'/content/drive/MyDrive/Colab Notebooks/Mask-R-CNN-using-Tensorflow2/dataset_raw/pv/val/pv_val_json.json')
    dataset_val.prepare()
